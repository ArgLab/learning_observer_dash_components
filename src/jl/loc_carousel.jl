...
"""
    loc_carousel(;kwargs...)
    loc_carousel(children::Any;kwargs...)
    loc_carousel(children_maker::Function;kwargs...)
...
function loc_carousel(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("loc_carousel", "Carousel", "learning_observer_components", available_props, wild_props; kwargs...)
end

loc_carousel(children::Any; kwargs...) = loc_carousel(;kwargs..., children = children)
loc_carousel(children_maker::Function; kwargs...) = loc_carousel(children_maker(); kwargs...)
