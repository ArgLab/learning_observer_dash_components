...
export loc_studentoverviewcardnobars

"""
    loc_studentoverviewcardnobars(;kwargs...)
...
"""
function loc_studentoverviewcardnobars(; kwargs...)
        available_props = Symbol[:id, :border, :class_name, :data, :name, :shown]
        wild_props = Symbol[]
        return Component("loc_studentoverviewcardnobars", "StudentOverviewCardNoBars", "learning_observer_components", available_props, wild_props; kwargs...)
end
