...
export loc_studentoverviewcard

"""
    loc_studentoverviewcard(;kwargs...)
...
"""
function loc_studentoverviewcard(; kwargs...)
        available_props = Symbol[:id, :border, :class_name, :data, :name, :shown]
        wild_props = Symbol[]
        return Component("loc_studentoverviewcard", "StudentOverviewCard", "learning_observer_components", available_props, wild_props; kwargs...)
end
