...
#' @export
'loc'CourseCarousel <- function(children=NULL, id=NULL, arrows=NULL, autoplay=NULL, center_mode=NULL, center_padding=NULL, class_name=NULL, dots=NULL, infinite=NULL, responsive=NULL, slides_to_scroll=NULL, slides_to_show=NULL, speed=NULL, style=NULL, swipe_to_slide=NULL, variable_width=NULL, vertical=NULL) {
